        ...
        var get_defaults = function() {
            ...
            return {
                ...
                i18n : {
                    ...
                    welcome : '<strong>Welcome to Elsha\'s page.</strong><br>Type <b>help</b> to list the available commands.<br><br>',
            ...
            **/
            public_methods.native_style = function(el, theme){
                ...
                if(theme === 'boring'){
                    var boring_theme = [
                        'body' +
                            '{ background-color: #111; font-weight: lighter; font-family: "Fira Code", Courier, monospace; background-color: #111; color: #00FF00; }' +
                        '.boring, .boring .prompt, .boring .content'+
                            '{ font-family: "Fira Code", Courier, monospace; background-color: #111; color: #00FF00; }',
                        '.boring .content'+
                        ...
                        '.boring .prompt .input, .boring .prompt .input::before, .boring .prompt .input::after'+
                            '{ color: transparent; text-shadow:0 0 0 #00FF00; }', // Caret remover hack
